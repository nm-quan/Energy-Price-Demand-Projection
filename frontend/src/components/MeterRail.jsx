...
function MeterCard({ meter, selected, onSelect }) {
  return (
    <button
      ...
      className={`w-full text-left rounded-lg border px-3.5 py-3 transition ${
        selected
...
export default function MeterRail({ meters, selectedId, onSelect }) {
  return (
    <aside
      data-testid="meter-rail"
      className="hidden lg:flex w-72 shrink-0 flex-col border-r border-line bg-white"
    >
